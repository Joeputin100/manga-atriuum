#!/usr/bin/env python3
"""
Add New Popular Series to Database

This script adds the 8 missing popular shonen series to the database.
"""
...
def main():
    """Add all 8 missing popular shonen series"""
    print("🚀 Adding 8 Missing Popular Shonen Series to Database")
    print("=" * 60)
    ...
    for series_name, max_vol in new_series:
        added = add_series(series_name, max_vol)
        total_added += added

    print(f"\n🎉 Grand Total: Added {total_added} volumes across {len(new_series)} new series!")
    print("Your manga database now includes the most popular recent shonen hits!")
